...
class LauncherHelper {
  static Future<void> launchURL({required String url, LaunchMode? mode}) async {
  ...
  static Future<void> openMap({
    ...
    log('https://www.google.com/maps/search/?api=1&query=$lat,$lng');
  ...
  static Future<void> openOsMap({
    required double lat,
    required double lng,
  }) async {
    final Uri androidUri = Uri.parse('google.navigation:q=$lat,$lng');
    final Uri iosUri = Uri.parse('https://maps.apple.com/?daddr=$lat,$lng');
